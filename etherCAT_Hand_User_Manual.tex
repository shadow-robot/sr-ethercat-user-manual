...
\begin{itemize}
\item Check you can access our stacks (if this command doesn't get you to the shadow\_robot folder, make sure you've installed the code properly and sourced the generated setup.sh as described in \link{install}):
  \begin{lstlisting}[escapeinside='']
> roscd shadow_robot
  \end{lstlisting}
